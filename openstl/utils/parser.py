...
def create_parser():
    ...
    parser.add_argument('--freeze_projection', action='store_true', default=False, help='Freeze projection layer of SVQ')
    parser.add_argument('--stochastic_sample_codes', action='store_true', default=False, help='stochastic_sample_codes')
