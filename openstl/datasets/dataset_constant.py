dataset_parameters = {
    ...
    **dict.fromkeys(['weather', 'weather_t2m_5_625'], {  # 2m_temperature
    ...
    'weather_hmv_4_4_s6_5_625': {  # high-dimensional multi-variant weather bench, 4->4 (1 day)
        'in_shape': [4, 8*13+6, 32, 64],
        'pre_seq_length': 4,
        'aft_seq_length': 4,
        'total_length': 8,
        'data_name': 'hmv',
        'train_time': ['1980', '2015'], 'val_time': ['2016', '2016'], 'test_time': ['2017', '2018'],
        'idx_in': [1 + i * 6 for i in range(-3, 0)] + [0, ],
        'idx_out': [i * 6 + 1 for i in range(4)],
        'step': 6,
